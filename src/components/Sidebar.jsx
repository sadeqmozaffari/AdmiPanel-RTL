        ...
        <>
          <div className="flex justify-between items-center">
            <Link
              ...
              className="flex items-center gap-3 mr-3 mt-4
            text-xl font-bold tracking-tight dark:text-white text-state-900"
            >
              <span
                className="border-2 border-gray-500 rounded-full p-[5px] flex
                items-center justify-center"
              >
                <SlPuzzle className="text-xl" />
              </span>
              <span>پــنل مـدیریـت </span>
            </Link>
            <TooltipComponent
              enableRtl={true}
              content="بستن مینو"
            ...
            >
              <button
                ...
                className="text-xl rounded-full p-1 hover:bg-light-gray
                dark:hover:bg-gray-500  ml-4 block dark:text-gray-50 lg:hidden"
              >
                <MdOutlineCancel />
              </button>
            </TooltipComponent>
